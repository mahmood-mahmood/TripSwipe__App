...
import 'package:tripswipe/views/users/cabselection.dart';
...
class cabbook2 extends StatefulWidget {
  const cabbook2({Key? key}) : super(key: key);

  @override
  State<cabbook2> createState() => _cabbook2State();
}

class _cabbook2State extends State<cabbook2> {
  @override
            ...
            Positioned(
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            fit: BoxFit.cover,
                            image: AssetImage(
                                "img/chooseyourride-removebg-preview.png"))),
                  ),
                  Text(
                    "Choose your Ride",
                    style: TextStyle(
                  ...
                  Text(
                    "Select your comfortable and ",
                    style: TextStyle(color: Colors.grey),
                  ),
                  Text(
                    "customized ride with variety of choices",
                    style: TextStyle(color: Colors.grey),
                  ),
                  SizedBox(
                    height: 30,
