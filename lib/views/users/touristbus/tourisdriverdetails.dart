...
import 'package:tripswipe/views/users/tempotravaller/tempoconfrm.dart';
import 'package:tripswipe/views/users/touristbus/buscnfm.dart';
import 'package:url_launcher/url_launcher.dart';
import 'package:latlong2/latlong.dart';

class TouristDriver extends StatelessWidget {
  const TouristDriver({Key? key}) : super(key: key);
              ...
              children: [
                Expanded(
                  child: Consumer<Controller>(
                      builder: (context, touristBusController, _) {
                    return FutureBuilder(
                        future: touristBusController.fetchCarsByCategory(
                            'travellers', 'Tourist bus'),
                        builder: (context, snapshot) {
                          return snapshot.connectionState ==
                              ...
                              : ListView.builder(
                                  itemCount:
                                      touristBusController.carsList.length,
