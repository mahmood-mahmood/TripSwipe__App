...
class AutoBook extends StatelessWidget {
  const AutoBook({Key? key}) : super(key: key);
              ...
              children: [
                Expanded(
                  child: Consumer<Controller>(
                      builder: (context, autoController, _) {
                    return FutureBuilder(
                        future: autoController.fetchAutos(),
                        builder: (context, snapshot) {
                          return snapshot.connectionState ==
                              ...
                              : ListView.builder(
                                  itemCount: autoController.autosList.length,
