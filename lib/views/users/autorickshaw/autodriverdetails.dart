...
import 'package:tripswipe/views/users/autorickshaw/bookanycnfm.dart';
import 'package:tripswipe/views/users/driverlist.dart';
import 'package:url_launcher/url_launcher.dart';
import 'package:latlong2/latlong.dart';

class autodrivedetail extends StatefulWidget {
  const autodrivedetail({Key? key}) : super(key: key);

  @override
  State<autodrivedetail> createState() => _autodrivedetailState();
}

class _autodrivedetailState extends State<autodrivedetail> {
  @override
                              ...
                              child: InkWell(
                                onTap: () {
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => bookanyautocnfm(
                                            img: drivers[index]['img'],
                                            name: drivers[index]['name'],
                                            rat: drivers[index]['rat'],
                                            type: drivers[index]['type'],
                                            carnam: drivers[index]['carnam'],
                                            numplate: drivers[index]
                                                ['numplate'],
                                            req: drivers[index]['req']),
                                      ));
                                },
                                child: Container(
