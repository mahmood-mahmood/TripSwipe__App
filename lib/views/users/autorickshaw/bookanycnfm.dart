...
class bookanyautocnfm extends StatefulWidget {
  bookanyautocnfm(
      {super.key,
      required this.img,
      required this.name,
  ...
  @override
  State<bookanyautocnfm> createState() => _bookanyautocnfmState();
}

class _bookanyautocnfmState extends State<bookanyautocnfm> {
  var pass = true;
      ...
      body: Container(
        ...
        child: Stack(
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(top: 198.0, left: 10),
              child: Card(
                color: Colors.white,
                child: Container(
                  height: 425,
