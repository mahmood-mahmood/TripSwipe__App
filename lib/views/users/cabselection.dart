...
import 'package:tripswipe/views/users/autorikbooking.dart';
import 'package:tripswipe/views/users/bookcar.dart';
import 'package:tripswipe/views/users/cabbookpages.dart';
import 'package:tripswipe/views/users/travallerbooking.dart';
import 'package:url_launcher/url_launcher.dart';

class Cabselect extends StatelessWidget {
  const Cabselect({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: [
        ...
        Padding(
            padding: const EdgeInsets.only(top: 310.0, left: 30, right: 15),
            child: Card(
                elevation: 10,
                child: Container(
                            ...
                            InkWell(
                              onTap: () {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => const autorikbook(),
                                    ));
                              },
                              child: Card(
                                  elevation: 5,
