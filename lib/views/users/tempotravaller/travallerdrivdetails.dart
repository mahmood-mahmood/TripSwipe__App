...
class TempoTravDriver extends StatelessWidget {
  const TempoTravDriver({Key? key}) : super(key: key);
              ...
              children: [
                Expanded(
                  child: Consumer<Controller>(
                      builder: (context, travellerController, _) {
                    return FutureBuilder(
                        future: travellerController.fetchCarsByCategory(
                        ...
                        builder: (context, snapshot) {
                          return snapshot.connectionState ==
                              ...
                              : ListView.builder(
                                  itemCount:
                                      travellerController.carsList.length,
