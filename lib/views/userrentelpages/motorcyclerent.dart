...
class motorent extends StatefulWidget {
  const motorent({Key? key}) : super(key: key);

  @override
  State<motorent> createState() => _motorentState();
}

class _motorentState extends State<motorent> {
  @override
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          CircleAvatar(
                                            backgroundColor: Colors.black,
                                            radius: 25,
                                            backgroundImage: bike[index]['img'],
                                          )
                                        ],
                                      ),
                                      const Padding(
